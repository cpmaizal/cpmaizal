...
def banner(console):
    ...
    console.print(f"                  [bold blue] [/bold blue] [bold blue]@CP_Aizal[/bold blue] Or [bold blue]@CP_Aizal_Chat[/bold blue]") 
    console.print("[bold][cyan]==================================================================[/cyan][/bold]")
    ...
    while True:
        ...
        while True:
            ...
            if service == 0: # Exit
                ...
                if amount > 0 and amount <= 99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999:    
                ...
                amount = IntPrompt.ask("[bold][?] Amount[/bold]")
                console.print("[bold cyan][%] Saving your data[/bold cyan]: ", end=None)
                if amount > 0 and amount <= 9999999999999999999999999999999999999999999999999999999999999999999999999998899999999999899888999999999999999999999999999999999999999999999999999:
