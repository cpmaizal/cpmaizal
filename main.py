...
def banner(console):
    ...
    brand_name =  "ââââââ   ââââââ   ââââ âââââ âââ       ââââââââââââ âââ       âââ    \n"
    brand_name += "ââââ ââ  ââââ  ââââââââââ âââââââââ    âââââ â â âââââââââ    ââââ    \n"
    brand_name += "âââ    â ââââ âââââââ    âââââââ  âââ  âââââ â ââââ âââ  âââ  ââââ    \n"
    brand_name += "ââââ âââââââââââ ââââ    âââ âââââââââ ââââ  âââ   ââââââââââ ââââ    \n"
    brand_name += "â âââââ âââââ â  âââââ   ââââ ââ   âââââââââââââââââ ââ   ââââââââââââ\n"
    brand_name += "â ââ â  âââââ â  ââ ââ   â  â ââ   ââââââ  âââ âââââ ââ   âââââ âââ  â\n"
    brand_name += "  â  â   ââ â     â  â      â  â   ââ â â ââââ â â â  â   ââ ââ â â  â\n"
    brand_name += "â        ââ       â      â     â   â    â ââ â â â â  â   â     â â   \n"
    brand_name += "â â                      â         â  â â    â â          â  â    â  â\n"
    brand_name += "â                                          â\n"
    colors = [
    ...
    console.print("\t   ðððððð ðððððð ðððð ððð ðððððð ððððð ðððð ðððð")
    console.print("   [bold][red]  ððððððð ððð ðððððð ððð ðð ððð ððððððð ððð ðððð ðð ððððððð[/bold][red]")
    console.print(f"             [bold green]ððð¥ðð ð«ðð¦ ððð [/bold green]: [bold cyan]@cpmsalebot[/bold cyan] ððð¥ðð ð«ðð¦ [bold cyan]@cpmtool[/bold cyan]") 
    console.print("[bold][red]==================================================================[/red][/bold]")
...
def load_key_data(cpm):
    ...
    console.print("[bold][red]===============[/bold][/red][ ððð§âð® ][bold][red]===============[/red][/bold]")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold][red]===============[/bold][/red][ ðððâ ][bold][red]===============[/red][/bold]")
