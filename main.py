...
def banner(console):
    ...
    console.print("\t  [bold] [green]                   👑 𝐂𝐏𝐌 𝐀𝐈𝐙𝐀𝐋 𝐊𝐔𝐑𝐃𝐈𝐒𝐇")
    ...
    console.print(f"             [bold blue]𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦 𝐁𝐎𝐓 [/bold blue]: [bold blue]@cpmsalebot[/bold blue] 𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦 [bold blue]@cpmtool[/bold blue]") 
    
    console.print("[bold][purple]==================================================================[/purple][/bold]")
